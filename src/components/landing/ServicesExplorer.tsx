...
const baseKeyServices: KeyService[] = [
  {
    ...
    href: "https://www.brickworkindia.com/procurement-operations/purchase-order-management",
    color: LOGO_COLORS.orange,
    icon: ShoppingCart,
    subServices: [
      ["PO Creation & Approvals", ClipboardCheck],
      ["Vendor Management", Users],
      ["Vendor PO Follow-ups", RefreshCw],
    ].map(([name, icon]) => ({
      name: name as string,
      href: "https://www.brickworkindia.com/procurement-operations/purchase-order-management",
...

  {
    ...
    href: "https://www.brickworkindia.com/procurement-operations/vendor-lifecycle-management",
    color: LOGO_COLORS.pink,
    icon: Users,
    subServices: [
      ["Create New Vendor IDs", UserPlus],
      ["Coordinate Vendor Contract Documents", FileCheck],
      ["Vendor Onboarding and Offboarding", Users],
      ["Vendor Performance Review", ClipboardCheck],
      ["Due-Diligence Checks", FileCheck],
      ["Contract Renewal Coordination", RefreshCw],
      ["Ordering Office Supplies, Software, and Peripherals", ShoppingCart],
      ["Invoice and Payment Follow-Up", RefreshCw],
    ].map(([name, icon]) => ({
      name: name as string,
      href: "https://www.brickworkindia.com/procurement-operations/vendor-lifecycle-management",
      icon: icon as ElementType,
  ...
  {
    name: "Inventory & Fulfillment Management",
    href: "https://www.brickworkindia.com/procurement-operations/inventory-and-fulfillment-management",
    color: LOGO_COLORS.green,
    icon: PackageCheck,
    subServices: [
      ["Inventory Monitoring & Reordering Triggers", Boxes],
      ["Order Management & Fulfillment Oversight", Truck],
    ].map(([name, icon]) => ({
      name: name as string,
      href: "https://www.brickworkindia.com/procurement-operations/inventory-and-fulfillment-management",
      icon: icon as ElementType,
  ...
  {
    name: "Strategic Sourcing & Spend Analysis",
    href: "https://www.brickworkindia.com/procurement-operations/strategic-sourcing-and-spend-analysis",
    color: LOGO_COLORS.blue,
    icon: ChartNoAxesCombined,
    subServices: [
      ["Spend Categorization", BarChart3],
      ["Cost Optimization Reporting", TrendingDown],
      ["Procurement Data Analytics", Database],
  ...
  {
    name: "e-Procurement Tools Support",
    href: "https://www.brickworkindia.com/procurement-operations/eprocurement-tools-support",
    color: LOGO_COLORS.orange,
    icon: Settings2,
    subServices: [
      ["Ariba, Coupa, and SAP MM Support", Settings2],
      ["PunchOut Catalogue and EDI Coordination", Database],
    ].map(([name, icon]) => ({
      name: name as string,
      href: "https://www.brickworkindia.com/procurement-operations/eprocurement-tools-support",
      icon: icon as ElementType,
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <a
                      href="https://www.brickworkindia.com/services/procurement-operations-services"
                      target="_blank"
                      rel="noreferrer"
                    ...
                    >
                      ...
                      <span
                        ...
                        "
                      >
                        Procurement Operation Services
                      </span>
